...
@section('content')
    <h1> 
        <div class="pl-10 pb-5">Properties</div>
    </h1>

    @if($property->isEmpty())
        <p>You don't have any properties yet.</p>
    @else
        <div class="row row-cols-1 row-cols-md-2 g-4 p-5 h-75 w-75">
                @foreach($property as $properties)
                    <div class="col">
                        <div class="card h-90 w-75">
                            <div class="card-body" style="text-align: left;" >
                                <img src="{{ asset($properties->photo) }}" class="card-img-top" alt="Image of the building" style="width: 280px;">
